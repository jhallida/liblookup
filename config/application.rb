...
module Liblookup
  class Application < Rails::Application
    ...
    config.x.crossref_books = "http://api.crossref.org/types/book/works?filter="
    config.x.open_library = "https://openlibrary.org/api/books?jscmd=data&format=json&bibkeys="

    config.x.service = ['crossref_isbn','crossref_issn','sherpa_issn','scopus_issn','issn_transfer','doaj_issn','google_books_isbn', 'openlibrary_isbn','openlibrary_lccn']
